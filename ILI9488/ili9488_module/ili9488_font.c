...
#if ( ILI9488_FONT_8_USE_EN )

	// Font source:
	// -> https://github.com/RobertoBenjami/stm32_graphics_display_drivers/tree/master/Drivers/Fonts/font8.c
	static const uint8_t ili9488_font8_lut[] =
	{
			// @0 ' ' (5 pixels wide)
			0x00, //
			0x00, //
...
#endif // ILI9488_FONT_8_USE_EN


#if ( ILI9488_FONT_12_USE_EN )

	// Font source:
	// -> https://github.com/RobertoBenjami/stm32_graphics_display_drivers/tree/master/Drivers/Fonts/font12.c
	static const uint8_t ili9488_font12_lut[] =
	{
		// @0 ' ' (7 pixels wide)
		0x00, //
		0x00, //
...
#endif // ILI9488_FONT_12_USE_EN


#if ( ILI9488_FONT_16_USE_EN )

	// Font source:
	// -> https://github.com/RobertoBenjami/stm32_graphics_display_drivers/tree/master/Drivers/Fonts/font16.c
	static const uint8_t ili9488_font16_lut[] =
	{
		// @0 ' ' (11 pixels wide)
		0x00, 0x00, //
		0x00, 0x00, //
...
#endif // ILI9488_FONT_16_USE_EN


#if ( ILI9488_FONT_20_USE_EN )

	// Font source:
	// -> https://github.com/RobertoBenjami/stm32_graphics_display_drivers/tree/master/Drivers/Fonts/font20.c
	static const uint8_t ili9488_font20_lut[] =
	{
		// @0 ' ' (14 pixels wide)
		0x00, 0x00, //
		0x00, 0x00, //
...
#endif // ILI9488_FONT_20_USE_EN


#if ( ILI9488_FONT_24_USE_EN )

	// Font source:
	// -> https://github.com/RobertoBenjami/stm32_graphics_display_drivers/tree/master/Drivers/Fonts/font24.c
	static const uint8_t ili9488_font24_lut[] =
	{
		// @0 ' ' (17 pixels wide)
		0x00, 0x00, 0x00, //
		0x00, 0x00, 0x00, //
...
#endif // ILI9488_FONT_24_USE_EN

// Font list
static const ili9488_font_t g_fontList[ eILI9488_FONT_NUM_OF ] =
{
	#if ( ILI9488_FONT_8_USE_EN )
		{ (uint8_t*) &ili9488_font8_lut, 	5U, 	8U 	},
	#else
		{ NULL, 0U, 0U },
	#endif

	#if ( ILI9488_FONT_12_USE_EN )
		{ (uint8_t*) &ili9488_font12_lut, 	7U, 	12U },
	#else
		{ NULL, 0U, 0U },
	#endif

	#if ( ILI9488_FONT_16_USE_EN )
		{ (uint8_t*) &ili9488_font16_lut, 	11U, 	16U },
	#else
		{ NULL, 0U, 0U },
	#endif

	#if ( ILI9488_FONT_20_USE_EN )
		{ (uint8_t*) &ili9488_font20_lut, 	14U, 	20U },
	#else
		{ NULL, 0U, 0U },
	#endif

	#if ( ILI9488_FONT_24_USE_EN )
		{ (uint8_t*) &ili9488_font24_lut, 	17U, 	24U },
	#else
		{ NULL, 0U, 0U },
	#endif
...
uint8_t	ili9488_font_get_height(const ili9488_font_opt_t font_opt)
{
	...
	if ( font_opt < eILI9488_FONT_NUM_OF )
	{
		width = g_fontList[ font_opt ].height;
	}
	else
	{
		width = 0;
